...
'''TEST_CASE_2: Factorial of Numbers between [10,100],it is compared with factorial calculated by factorial function in Python Math module. 
...
def test_factorial_positiveinteger_chrome():
    expectedResult = calcExpectedFactorialRange(95,101,1)
    actualResult = calcFactorialRangeOnChrome(95,101,1)
    assert expectedResult == actualResult
    
    
'''TEST_CASE_3: Factorial of Numbers between [10,100],it is compared with factorial calculated by factorial function in Python Math module. 
This test-case is run on the Firefox Browser. Test Input includes boundary conditions at lower (9) and upper bounds (101)'''
@pytest.mark.cross_browser    
def test_factorial_positiveinteger_firefox():
    expectedResult = calcExpectedFactorialRange(0,102,1)
    actualResult = calcFactorialRangeOnFirefox(0,102,1)
    assert expectedResult == actualResult
...
@pytest.mark.parametrize(
    "items,expected",
    [
        (+3, [[3,6]]),  #BaseNumber is +3, second value is the base number and its expected output
    ],
)
...
@pytest.mark.parametrize(
    "items,expected",
    [
        (500, 'The factorial of 500 is: Infinity'),  #BaseNumber is 500, second value is the expected message calculator should show
    ],
)
...
@pytest.mark.parametrize(
    "items,expected",
    [
        (1000, 'The factorial of 1000 is: Infinity'),  #BaseNumber is 1000, second value is the expected message calculator should show
    ],
)
...
'''TEST_CASE_8: Factorial of -ive numbers, expected result is: Calculator should print a message: Please enter a positive integer '''
@pytest.mark.parametrize(
    "items,expected",
    [
        (-2, 'Please enter a positive integer'),  #BaseNumber is -2, second value is the expected message calculator should show
    ],
)
...
'''TEST_CASE_9: Factorial of a String, expected result is: Calculator should print a message: Please enter an integer '''
@pytest.mark.parametrize(
    "items,expected",
    [
        ('abc', 'Please enter an integer'),  #BaseNumber is a string, second value is the expected message calculator should show
    ],
)
...
'''TEST_CASE_10: Factorial of an alphanumeric, expected result is: Calculator should print a message: Please enter an integer '''
@pytest.mark.parametrize(
    "items,expected",
    [
        ('12abc', 'Please enter an integer'),  #BaseNumber is an alphanumeric string, second value is the expected message calculator should show
    ],
)
def test_factorial_alphanumeric(items, expected):
    actualResult = calcFactorialUnexpected(items)
    assert actualResult  == expected
